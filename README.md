...
<br>
<br><b>How to launch the similarity script:</b>
<br>`python ./similarity --path_signature '/path/to/signature' --path_feps '/path/to/feps/or/any/other/signature' --path_output /path/to/output`
